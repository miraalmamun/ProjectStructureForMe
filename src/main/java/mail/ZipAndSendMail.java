...
public class ZipAndSendMail {
	...
	static String[] toEmails = { "mir590875@gmail.com" };
	static String fromUser = "mir590875@gmail.com";// imap on, other devices on, no recovery phone
	static String password = "Mimo949658";
